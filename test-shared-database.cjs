...
// Test functions
async function testSharedDatabaseFlow() {
  console.log('🚀 Testing Shared Database Flow...');
  console.log('=' .repeat(60));

  try {
    // Step 1: Register a new device with FCM token
    console.log('\n📱 Step 1: Registering new device with FCM token...');
    ...
    console.log('\n✅ Shared database flow test completed!');
