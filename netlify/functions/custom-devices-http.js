// HTTP-based Custom Devices API for Netlify Functions (No MongoDB dependency)
...
// Simple in-memory database for demo (will be replaced with HTTP calls to MongoDB service)
